...
#if !defined(HPX_RUNTIME_RUNTIME_IMPL_DISTRIBUTED_HPP)
#define HPX_RUNTIME_RUNTIME_IMPL_DISTRIBUTED_HPP
...
namespace hpx
{
    ...
    class HPX_EXPORT runtime_impl_distributed
      : public runtime_impl_local
      , public runtime_distributed
    {
    private:
        // avoid warnings about usage of this in member initializer list
        runtime_impl_distributed* This() { return this; }
    ...
    public:
        ...
        void register_message_handler(char const* message_handler_type,
            char const* action, error_code& ec = throws) override;
        parcelset::policies::message_handler* create_message_handler(
            char const* message_handler_type, char const* action,
            parcelset::parcelport* pp, std::size_t num_messages,
            std::size_t interval, error_code& ec = throws) override;
        serialization::binary_filter* create_binary_filter(
            char const* binary_filter_type, bool compress,
            serialization::binary_filter* next_filter, error_code& ec = throws) override;
